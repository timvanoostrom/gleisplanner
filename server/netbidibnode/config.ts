export const NET_BIDIB_PROTOCOL_SIGNATURE = 'BiDiB-Relay-Node';

export const BidibLinkDescriptor = {
  signature: NET_BIDIB_PROTOCOL_SIGNATURE,
  prod: 'BiDiB-Relay-Node',
  user: 'Schuurbaan',
  uid: [0xc0, 0x00, 0x0d, 0x02, 0x78, 0x45, 0x6b],
  // version: 0.1,
};

export const BIDIB_PROTOCOL_LOW = 0x07;
export const BIDIB_PROTOCOL_HIGH = 0x00;

export const UNKNOWN = 'UNKNOWN_TYPE';

export type NodeAddress = [number, number, number, 0x00];
export type BidibMessage = number[];
export type BidibMessageType = number;
